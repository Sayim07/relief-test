...
const Hyperspeed = ({
    ...
    useEffect(() => {
        ...
        class App {
            ...
            constructor(container: HTMLElement, options: any = {}) {
                ...
                let fogColor = new THREE.Color(options.colors.background);
                let fog = new THREE.Fog(fogColor, options.length * 0.2, options.length * 500);
                this.scene.fog = fog;
                this.fogUniforms = {
    ...
    `;
        ...
        class Road {
            ...
            options: any;
            uTime: { value: number };
            leftRoadWay: THREE.Mesh | any;
            rightRoadWay: THREE.Mesh | any;
            island: THREE.Mesh | any;
