      ...
      <div className="bg-[#060010] border border-[#392e4e] rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-400">Your donation has been recorded and a receipt has been generated.</p>
          </div>
          ...
          <div className="bg-[#0a0a1a] border border-[#392e4e] rounded-lg p-6 text-center mb-6">
            <p className="text-sm font-medium text-gray-300 mb-4">Receipt QR Code</p>
            {qrLoading ? (
