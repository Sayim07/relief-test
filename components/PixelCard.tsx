...
import { useEffect, useRef, forwardRef, ReactNode, FocusEvent } from 'react';
...
const PixelCard = ({ variant = 'default', gap, speed, colors, noFocus, className = '', children }: PixelCardProps) => {
